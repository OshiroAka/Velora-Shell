...
Item {
    ...
    Item {
        ...
        x: 0
        y: 0
        width: bar.themeDrawerVisible ? bar.railWidth + bar.themeAnimatedWidth : 0
    ...
    Rectangle {
        ...
        x: 2
        y: 4
        width: bar.railWidth + bar.themeAnimatedWidth - 2
    ...
    Rectangle {
        ...
        x: 0
        y: 0
        width: bar.railWidth + bar.themeAnimatedWidth
        height: bar.themeDrawerHeight
        radius: bar.cornerRadius
        bottomLeftRadius: 0
    ...
    Rectangle {
        x: bar.cornerRadius
        y: 0
        width: bar.themeSurfaceActive ? bar.railWidth - bar.cornerRadius : bar.railWidth - bar.cornerRadius * 2
        height: 1
        color: Qt.rgba(0.58, 0.72, 0.86, 0.20)
    }
    ...
    Rectangle {
        x: surface.width - 4
        y: bar.themeSurfaceActive ? Math.min(surface.height - 14, bar.themeDrawerHeight + 4) : 14
        width: 1
