...
Item {
    ...
    property bool wallpaperBlurEnabled: true
    ...
    property real wallpaperBlurStrength: 0.62
    property real wallpaperBlurFadeDuration: 1.40
    property real wallpaperBlurHoldDuration: 0.18
    ...
    readonly property int wallpaperBlurRadius: Math.round(8 + wallpaperBlurStrength * 34)
    readonly property string wallpaperBlurBezier: "0.05,0.7,0.1,1"
    ...
    function openMusic(px, py, pw, ph) {
        if (px !== undefined) {
            var anchorOffsetY = launcherPopup.anchor.rect.y - musicPopup.anchor.rect.y
            musicOriginX = px
            musicOriginY = py + anchorOffsetY
            musicOriginW = pw || musicOriginW
            musicOriginH = ph || musicOriginH
        }
    ...
    function applyWallpaper(item) {
        ...
        wallpaperApplyProcess.command = [
            ...
            item.preview || "",
            "fade",
            wallpaperBlurEnabled ? "1" : "0",
            String(wallpaperBlurRadius),
            String(wallpaperBlurHoldDuration),
            String(wallpaperBlurFadeDuration),
            wallpaperBlurBezier
        ]
    ...
    Process {
        ...
        onExited: {
            ...
            if (bar.pendingWallpaperKey.length > 0) {
                bar.currentWallpaperKey = bar.pendingWallpaperKey
                bar.pendingWallpaperKey = ""
            }
            bar.pywalAccentEnabled = true
    ...
    Column {
        ...
        Rectangle {
            ...
            MouseArea {
                ...
                onEntered: bar.profileHovered = true
                onExited: bar.profileHovered = false
                onClicked: bar.toggleProfile()
            }
        }
    }
    ...
    PopupWindow {
        ...
        visible: bar.launcherOpen || bar.launcherMounted
        color: "transparent"
        implicitWidth: 316
        implicitHeight: 560

        anchor.item: toolsGroup
        anchor.rect.x: toolsGroup.width + 16
        anchor.rect.y: Math.round((toolsGroup.height / 2) - implicitHeight * 0.48)
        anchor.rect.width: 1
        anchor.rect.height: 1
        ...
        Item {
            ...
            readonly property real iconOriginX: toolsGroup.width / 2 - launcherPopup.anchor.rect.x
            readonly property real iconOriginY: 61 - launcherPopup.anchor.rect.y

            width: parent.width
            height: parent.height
            x: bar.launcherOpen ? 0 : -3
            y: bar.launcherOpen ? 0 : 3
            opacity: bar.launcherOpen ? 1 : 0
            enabled: bar.launcherOpen
            transform: Scale {
                id: launcherOpenScale

                origin.x: launcherMotion.iconOriginX
                origin.y: launcherMotion.iconOriginY
                xScale: bar.launcherOpen ? 1.0 : 0.08
                yScale: bar.launcherOpen ? 1.0 : 0.08

                Behavior on xScale { NumberAnimation { duration: 255; easing.type: Easing.OutBack; easing.overshoot: 1.04 } }
                Behavior on yScale { NumberAnimation { duration: 255; easing.type: Easing.OutBack; easing.overshoot: 1.04 } }
            }
            ...
            Rectangle {
                x: 4
                y: Math.round(launcherMotion.iconOriginY - height / 2)
                width: 18
                height: 18
                radius: 2
                rotation: 45
            ...
            Rectangle {
                ...
                color: Qt.rgba(0.055, 0.070, 0.082, 0.92)
                border.width: 1
                border.color: Qt.rgba(0.74, 0.82, 0.90, 0.18)
                clip: true
    ...
    PopupWindow {
        ...
        anchor.item: toolsGroup
        anchor.rect.x: toolsGroup.width + 16
        anchor.rect.y: Math.round((toolsGroup.height / 2) - implicitHeight * 0.42)
        anchor.rect.width: 1
        anchor.rect.height: 1
        ...
        Item {
            ...
            width: parent.width
            height: parent.height
            x: bar.musicOpen ? 0 : Math.round(bar.musicOriginX)
            y: bar.musicOpen ? 0 : Math.round(bar.musicOriginY)
            opacity: bar.musicOpen ? 1 : 0
            scale: bar.musicOpen ? 1 : Math.max(0.16, Math.min(0.30, bar.musicOriginW / Math.max(1, width)))
            ...
            Rectangle {
                ...
                anchors.margins: 2
                radius: 22
                color: Qt.rgba(0.050, 0.065, 0.078, 0.94)
                border.width: 1
                border.color: Qt.rgba(0.74, 0.82, 0.90, 0.18)
                clip: true
                ...
                Column {
                    ...
                    Rectangle {
                        ...
                        height: 350
                        radius: 18
                        color: Qt.rgba(0.055, 0.078, 0.096, 0.44)
                        border.width: 1
                        border.color: Qt.rgba(0.74, 0.82, 0.90, 0.15)
                        clip: true
                        ...
                        Column {
                            ...
                            Row {
                                ...
                                Rectangle {
                                    ...
                                    height: 158
                                    radius: 14
                                    color: Qt.rgba(0.09, 0.12, 0.16, 0.76)
                                    border.width: 1
                                    border.color: Qt.rgba(0.80, 0.88, 0.96, 0.15)
                                    clip: true
                                    ...
                                    OpacityMask {
                                        ...
                                        visible: musicArtImage.source.toString().length > 0 && musicArtImage.status === Image.Ready
                                    }

                                    Rectangle {
                                        anchors.fill: parent
                                        visible: musicArtImage.source.toString().length === 0 || musicArtImage.status !== Image.Ready
                                        color: Qt.rgba(0.10, 0.14, 0.18, 0.94)
                                ...
                                Column {
                                    width: parent.width - musicArtFrame.width - parent.spacing
                                    anchors.verticalCenter: parent.verticalCenter
                                    spacing: 10
                                    ...
                                    Rectangle {
                                        width: Math.min(parent.width, codecText.implicitWidth + 26)
                                        height: 28
                                        radius: 8
                                        color: Qt.rgba(0.72, 0.82, 0.92, 0.08)
                                        border.width: 1
                                        ...
                                        Row {
                                            ...
                                            Text {
                                                ...
                                                text: "Spotify"
                                                color: Qt.rgba(0.80, 0.87, 0.96, 0.80)
                                                font.family: "JetBrainsMono Nerd Font"
                                                font.pixelSize: 11
                                            }
                                        }
                            ...
                            Row {
                                ...
                                Text {
                                    width: parent.width / 2
                                    text: bar.mediaAvailable && bar.mediaLength > 0 ? bar.formatMediaTime(bar.mediaLength) : "0:00"
                                    color: bar.dimText
                    ...
                    Row {
                        ...
                        Rectangle {
                            ...
                            radius: 10
                            anchors.verticalCenter: parent.verticalCenter
                            color: Qt.rgba(0.72, 0.82, 0.92, 0.06)
                            border.width: 1
                            border.color: Qt.rgba(0.72, 0.82, 0.92, 0.13)
                            ...
                            Text {
                                anchors.centerIn: parent
                                text: "Refresh"
                                color: Qt.rgba(0.80, 0.87, 0.96, 0.84)
                                font.family: "JetBrainsMono Nerd Font"
                                font.pixelSize: 11
                            }
                    ...
                    Rectangle {
                        ...
                        height: 172
                        radius: 14
                        color: Qt.rgba(0.055, 0.078, 0.096, 0.34)
                        border.width: 1
                        border.color: Qt.rgba(0.74, 0.82, 0.90, 0.12)
                        clip: true
                        ...
                        Column {
                            ...
                            Repeater {
                                model: bar.musicQueueEntries.slice(0, 3)
    ...
    PopupWindow {
        ...
        visible: bar.themesOpen || bar.themesMounted
        color: "transparent"
        implicitWidth: 332
        implicitHeight: 664

        anchor.item: topGroup
        anchor.rect.x: topGroup.width + 16
        anchor.rect.y: -18
        anchor.rect.width: 1
        anchor.rect.height: 1
        ...
        Item {
            ...
            readonly property real iconOriginX: topGroup.width / 2 - themesPopup.anchor.rect.x
            readonly property real iconOriginY: 23 - themesPopup.anchor.rect.y

            width: parent.width
            height: parent.height
            x: bar.themesOpen ? 0 : -3
            y: bar.themesOpen ? 0 : -2
            opacity: bar.themesOpen ? 1 : 0
            enabled: bar.themesOpen
            transform: Scale {
                id: themesOpenScale

                origin.x: themesMotion.iconOriginX
                origin.y: themesMotion.iconOriginY
                xScale: bar.themesOpen ? 1.0 : 0.08
                yScale: bar.themesOpen ? 1.0 : 0.08

                Behavior on xScale { NumberAnimation { duration: 250; easing.type: Easing.OutBack; easing.overshoot: 1.02 } }
                Behavior on yScale { NumberAnimation { duration: 250; easing.type: Easing.OutBack; easing.overshoot: 1.02 } }
            }
            ...
            Rectangle {
                x: 4
                y: Math.round(themesMotion.iconOriginY - height / 2)
                width: 18
                height: 18
                radius: 2
                rotation: 45
                color: Qt.rgba(0.055, 0.070, 0.082, 0.93)
                border.width: 1
                border.color: Qt.rgba(bar.accent.r, bar.accent.g, bar.accent.b, 0.30)
            }
            ...
            Rectangle {
                ...
                color: Qt.rgba(0.055, 0.070, 0.082, 0.93)
                border.width: 1
                border.color: Qt.rgba(bar.accent.r, bar.accent.g, bar.accent.b, 0.22)
                clip: true
                ...
                Column {
                    ...
                    Row {
                        ...
                        TogglePill {
                            ...
                            onPressed: bar.autoThemeSwitch = !bar.autoThemeSwitch
                        }
                    }
                    ...
                    Row {
                        ...
                        Column {
                            ...
                            Text {
                                text: bar.wallpaperBlurEnabled ? Math.round(bar.wallpaperBlurStrength * 100) + "% + " + bar.wallpaperBlurFadeDuration.toFixed(1) + "s fade" : "Disabled"
                                color: bar.dimText
                                font.family: "JetBrainsMono Nerd Font"
                                font.pixelSize: 10
                            }
                        ...
                        TogglePill {
                            anchors.verticalCenter: parent.verticalCenter
                            checked: bar.wallpaperBlurEnabled
                            onPressed: bar.wallpaperBlurEnabled = !bar.wallpaperBlurEnabled
                        }
                        ...
                        WallpaperBlurSlider {
                            anchors.verticalCenter: parent.verticalCenter
                            width: 90
                            enabled: bar.wallpaperBlurEnabled
                        }
                    }
                    ...
                    Row {
                        ...
                        Column {
                            ...
                            Text {
                                text: "Adjust interface transparency"
                                color: bar.dimText
                                font.family: "JetBrainsMono Nerd Font"
                                font.pixelSize: 10
                            }
        ...
        MouseArea {
            ...
            onClicked: {
                if (root.usesPywal) {
                    ...
                    bar.pywalAccentEnabled = false
                    bar.manualAccentChoice = root.swatchColor
                }
            }
        }
    }
    ...
    component WallpaperCategoryChip: Rectangle {
        ...
        MouseArea {
            anchors.fill: parent
            cursorShape: Qt.PointingHandCursor
            onClicked: bar.setWallpaperCategory(chip.categoryKey)
        }
    }
    ...
    component OpacitySlider: Item {
        ...
        MouseArea {
            ...
            function setFromX(px) {
                bar.interfaceOpacity = 0.25 + bar.clamp01(px / Math.max(1, width)) * 0.55
            }
    ...
    component WallpaperBlurSlider: Item {
        id: slider
        ...
        Rectangle {
            ...
            Rectangle {
                width: parent.width * bar.clamp01(bar.wallpaperBlurStrength)
                height: parent.height
                radius: parent.radius
                color: bar.accent
            }
        ...
        Rectangle {
            ...
            height: 12
            radius: 6
            x: Math.max(0, Math.min(parent.width - width, parent.width * bar.clamp01(bar.wallpaperBlurStrength) - width / 2))
            anchors.verticalCenter: parent.verticalCenter
            color: bar.text
            border.width: 1
            border.color: bar.accent
        ...
        MouseArea {
            ...
            function setFromX(px) {
                bar.wallpaperBlurStrength = bar.clamp01(px / Math.max(1, width))
            }
