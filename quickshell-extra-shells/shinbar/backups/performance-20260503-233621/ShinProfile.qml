...
Item {
    ...
    function replayProfileEntrance() {
        introAvatarAnim.restart()
        introTextAnim.restart()
    ...
    SequentialAnimation {
        ...
        ScriptAction { script: root.introAvatar = 0.0 }
        PauseAnimation { duration: ShinData.popupAnim(70) }
        NumberAnimation {
            target: root
            property: "introAvatar"
            from: 0.0
            to: 1.0
    ...
    SequentialAnimation {
        ...
        ScriptAction { script: root.introText = 0.0 }
        PauseAnimation { duration: ShinData.popupAnim(140) }
        NumberAnimation {
            target: root
            property: "introText"
            from: 0.0
            to: 1.0
            duration: ShinData.popupAnim(380)
            easing.type: Easing.OutCubic
        }
    }
    ...
    PopupWindow {
        ...
        Repeater {
            ...
            Rectangle {
                ...
                radius: 24
                antialiasing: true
                visible: ShinConfig.trailEnabled && root.popupVisible && root.reveal > 0.02
                opacity: (0.16 - index * 0.04) * root.reveal
        ...
        Rectangle {
            ...
            Row {
                ...
                Item {
                    ...
                    opacity: root.introAvatar
                    scale: 0.94 + root.introAvatar * 0.06
                    transform: Translate {
                        x: -20 * (1.0 - root.introAvatar)
                    }
                ...
                Column {
                    ...
                    transform: Translate {
                        x: 20 * (1.0 - root.introText)
                        y: 8 * (1.0 - root.introText)
                    }
