...
Item {
    ...
    property color accentChoice: Qt.rgba(0.61, 0.82, 1.0, 0.96)
    ...
    PopupWindow {
        ...
        Item {
            ...
            x: bar.launcherOpen ? 0 : -14
            y: bar.launcherOpen ? 0 : 8
            opacity: bar.launcherOpen ? 1 : 0
            scale: bar.launcherOpen ? 1 : 0.94
            ...
            Behavior on scale { NumberAnimation { duration: 190; easing.type: Easing.OutBack; easing.overshoot: 1.15 } }
            ...
            Rectangle {
                x: 4
                y: Math.round(parent.height * 0.48) - 9
                width: 18
                height: 18
                radius: 2
                rotation: 45
                ...
                Column {
                    ...
                    Rectangle {
                        ...
                        TextInput {
                            ...
                            color: bar.text
                            selectionColor: Qt.rgba(0.60, 0.76, 0.90, 0.28)
    ...
    PopupWindow {
        ...
        Item {
            ...
            width: parent.width
            height: parent.height
            x: bar.themesOpen ? 0 : -14
            y: bar.themesOpen ? 0 : -8
            opacity: bar.themesOpen ? 1 : 0
            scale: bar.themesOpen ? 1 : 0.94
                ...
                Column {
                    ...
                    Item {
                        ...
                        Row {
                            ...
                            Repeater {
                                model: bar.wallpaperFiltered.slice(0, 3)

                                WallpaperThumb {
                                    width: Math.floor((wallpaperRow.width - 16) / 3)
    ...
    component AccentSwatch: Item {
        ...
        MouseArea {
            anchors.fill: parent
            cursorShape: Qt.PointingHandCursor
            onClicked: bar.accentChoice = root.swatchColor
        }
    }
