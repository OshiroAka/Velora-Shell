...
Item {
    ...
    property real introInfo: 1.0
    property real introControls: 1.0
    property real introLyrics: 1.0
    ...
    function cardRadius(t) {
        return lerp(22, 22, emphasizedDecel(t))
    }
    ...
    function replayPanelEntrance() {
        introHeaderAnim.restart()
        introCoverAnim.restart()
        introInfoAnim.restart()
        introControlsAnim.restart()
        introLyricsAnim.restart()
        sweepAnim.restart()
    }
    ...
    NumberAnimation {
        ...
        duration: ShinData.popupAnim(840)
        easing.type: Easing.OutCubic
    }
    ...
    SequentialAnimation {
        ...
        ScriptAction { script: root.introHeader = 0.0 }
        PauseAnimation { duration: ShinData.popupAnim(60) }
        NumberAnimation {
            target: root
    ...
    SequentialAnimation {
        ...
        ScriptAction { script: root.introCover = 0.0 }
        PauseAnimation { duration: ShinData.popupAnim(110) }
        NumberAnimation {
            target: root
            property: "introCover"
            from: 0.0
    ...
    SequentialAnimation {
        ...
        ScriptAction { script: root.introInfo = 0.0 }
    ...
    SequentialAnimation {
        id: introControlsAnim

        ScriptAction { script: root.introControls = 0.0 }
        ...
        NumberAnimation {
            ...
            from: 0.0
            to: 1.0
            duration: ShinData.popupAnim(410)
            easing.type: Easing.OutCubic
        }
    }
    ...
    SequentialAnimation {
        ...
        ScriptAction { script: root.introLyrics = 0.0 }
        PauseAnimation { duration: ShinData.popupAnim(340) }
        NumberAnimation {
            target: root
            property: "introLyrics"
            from: 0.0
            to: 1.0
    ...
    PopupWindow {
        ...
        anchor.item: root
        anchor.rect.x: Math.round(root.implicitWidth + 174 - mediaPopup.implicitWidth)
        ...
        Rectangle {
            ...
            Row {
                ...
                height: 24
                opacity: card.ct * root.introHeader
                transform: Translate { y: -8 * (1.0 - root.introHeader) }
            ...
            Rectangle {
                ...
                antialiasing: true
                clip: true
                opacity: card.ct * root.introCover
                scale: (0.97 + card.ct * 0.03) * (0.965 + root.introCover * 0.035)
                ...
                transform: Translate { y: 14 * (1.0 - root.introCover) }
                ...
                Row {
                    ...
                    Repeater {
                        ...
                        Rectangle {
                            ...
                            radius: width / 2
                            color: Qt.rgba(ShinColors.fg.r, ShinColors.fg.g, ShinColors.fg.b, root.player && root.player.isPlaying ? 0.82 : 0.50)
            ...
            Text {
                ...
                opacity: card.ct * root.introInfo
                transform: Translate { y: root.lerp(-8, 0, card.ct) + 8 * (1.0 - root.introInfo) }
            }
            ...
            Text {
                ...
                elide: Text.ElideRight
                opacity: card.ct * root.introInfo
                transform: Translate { y: root.lerp(-6, 0, card.ct) + 8 * (1.0 - root.introInfo) }
            }

            Row {
                x: parent.width - 76
                y: cover.y + cover.height + 19
                width: 60
                height: 26
                spacing: 8
                opacity: card.ct * root.introInfo
                transform: Translate { x: 12 * (1.0 - root.introInfo) }
            ...
            Item {
                ...
                width: parent.width - 32
                height: 24
                opacity: card.ct * root.introControls
                transform: Translate { y: 10 * (1.0 - root.introControls) }
            ...
            Rectangle {
                ...
                radius: 18
                opacity: card.ct * root.introControls
                scale: 0.975 + root.introControls * 0.025
                ...
                transform: Translate { y: 12 * (1.0 - root.introControls) }
            ...
            Rectangle {
                ...
                radius: 18
                visible: height > 54
                opacity: card.ct * root.introLyrics
                scale: 0.975 + root.introLyrics * 0.025
                clip: true
                ...
                transform: Translate { y: 14 * (1.0 - root.introLyrics) }
    ...
    component MediaButton: Rectangle {
        ...
        width: floating ? 24 : small ? 30 : (primary ? 38 : 32)
        height: width
        radius: width / 2
        color: floating
            ? "transparent"
        ...
        Canvas {
            id: iconCanvas
            anchors.centerIn: parent
            width: btn.floating ? 16 : btn.primary ? 18 : btn.small ? 14 : 16
            height: width
