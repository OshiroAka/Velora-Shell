...
Item {
    ...
    Text {
        ...
        text: "󰂯"
        color: root.opened ? ShinColors.accent : root.btOn ? ShinColors.fg : ShinColors.muted
        font.pixelSize: 15
    ...
    component DeviceRow: Rectangle {
        ...
        height: 54
        radius: 14
        color: rowArea.containsMouse ? Qt.rgba(ShinColors.fg.r, ShinColors.fg.g, ShinColors.fg.b, 0.07) : "transparent"
