...
Item {
    ...
    readonly property int desiredShellWidth: shellBaseWidth + themeMainWidth + themeSettingsWidth
    ...
    readonly property color activePanelBase: themeDrawerVisible ? joinedPanelBase : panelBase
    ...
    Item {
        ...
        x: 0
        y: 0
        width: bar.themeDrawerVisible ? bar.railWidth + bar.themeDrawerWidth : 0
    ...
    Rectangle {
        ...
        x: 2
        y: 4
        width: bar.railWidth + bar.themeDrawerWidth - 2
        height: bar.themeDrawerHeight - 3
        radius: bar.cornerRadius
        bottomLeftRadius: 0
        color: Qt.rgba(0.0, 0.0, 0.0, 0.14)
    }
    ...
    Rectangle {
        ...
        x: 0
        y: 0
        width: bar.railWidth + bar.themeDrawerWidth
        height: bar.themeDrawerHeight
        radius: bar.cornerRadius
        bottomLeftRadius: 0
    ...
    Rectangle {
        visible: bar.themeDrawerVisible
        x: 0
        y: bar.themeDrawerHeight
        width: bar.railWidth
        height: Math.max(0, parent.height - bar.themeDrawerHeight)
        radius: bar.cornerRadius
        topLeftRadius: 0
        topRightRadius: 0
        color: bar.activePanelBase
    ...
    Item {
        ...
        Rectangle {
            x: 0
            y: 0
            width: parent.width - bar.cornerRadius
            height: 1
    ...
    Rectangle {
        x: bar.cornerRadius
        y: 0
        width: bar.themeDrawerVisible ? bar.railWidth - bar.cornerRadius : bar.railWidth - bar.cornerRadius * 2
        height: 1
        color: Qt.rgba(0.58, 0.72, 0.86, 0.20)
    }
    ...
    Rectangle {
        x: surface.width - 4
        y: bar.themeDrawerVisible ? Math.min(surface.height - 14, bar.themeDrawerHeight + 4) : 14
        width: 1
    ...
    Item {
        ...
        Item {
            ...
            transform: Scale {
                ...
                xScale: bar.themesOpen ? 1.0 : 0.92
                yScale: 1.0

                Behavior on xScale { NumberAnimation { duration: 260; easing.type: Easing.OutCubic } }
            }
    ...
    component WallpaperTransitionChip: Rectangle {
        ...
        MouseArea {
            anchors.fill: parent
            cursorShape: Qt.PointingHandCursor
            onClicked: bar.wallpaperTransitionType = chip.transitionKey
        }
    }
    ...
    component TransitionSpeedSlider: Item {
        ...
        MouseArea {
            ...
            function setFromX(px) {
                bar.wallpaperTransitionDuration = 3.0 - bar.clamp01(px / Math.max(1, width)) * 2.75
            }
