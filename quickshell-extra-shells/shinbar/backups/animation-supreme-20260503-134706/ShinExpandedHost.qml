    ...
    Item {
        ...
        Repeater {
            ...
            Rectangle {
                ...
                visible: win.visible && (openAnim.running || closeAnim.running)
        ...
        Rectangle {
            ...
            Image {
                anchors.fill: parent
                visible: win.page === "weather" && ShinData.weatherBg.length > 0
            ...
            Rectangle {
                ...
                color: Qt.rgba(
                    ...
                    win.page === "weather" && ShinData.weatherBg.length > 0 ? 0.34 : 0.0
                )
            }
