        ...
        Rectangle {
            ...
            Column {
                ...
                Row {
                    ...
                    Rectangle {
                        ...
                        Text {
                            ...
                            font.pixelSize: Math.round(root.lerp(13, 24, card.ct))
                            font.bold: true
                            font.family: ShinConfig.fontFamily
                        }
                    }
                    ...
                    Column {
                        ...
                        Text {
                            width: parent.width
                            text: root.charging ? "Energia conectada" : "Bateria"
                            color: ShinColors.fg
                        ...
                        Rectangle {
                            ...
                            clip: true
                            Rectangle {
                                width: parent.width * root.clamp01(root.pct / 100)
                    ...
                    Rectangle {
                        ...
                        scale: root.settingsButtonSelected ? 1.06 : 1.0
                ...
                Rectangle {
                    ...
                    scale: settingsMiniArea.containsMouse ? 1.025 : 1.0
                ...
                Grid {
                    ...
                    Repeater {
                        model: [
                            { label: "CPU", value: root.cpuPct + "%", pct: root.cpuPct, sub: root.temp > 0 ? root.temp + "°C" : root.procs + " proc" },
                            { label: "RAM", value: root.ramUsed + " / " + root.ramTotal + " GiB", pct: root.ramPct, sub: root.ramPct + "% usado" },
                            { label: "Swap", value: root.swapUsed + " / " + root.swapTotal + " GiB", pct: root.swapPct, sub: root.swapPct + "% usado" },
                            { label: "Disco", value: root.diskUsed + " / " + root.diskTotal + " GiB", pct: root.diskPct, sub: root.diskPct + "% em ~" }
                        ]
                        ...
                        Rectangle {
                            ...
                            Column {
                                ...
                                Row {
                                    width: parent.width
                                    height: root.lerp(12, 18, card.ct)
